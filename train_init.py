...
def run_mentalhealth_online(interpreter,
	...
	agent = Agent(domain_file,
					policies=[MemoizationPolicy(max_history=2), KerasPolicy(max_history=3, epochs=500, batch_size=50), FormPolicy(), fallback],
...
if __name__ == '__main__':
    ...
    run_mentalhealth_online(nlu_interpreter)